  ...
  <section class="settings">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem">
        ...
        <div v-if="showCodeInput" class="code-redeem-wrap">
          <div class="form-field code-field">
            ...
            <small
              v-if="codeMsg"
              :style="{color: codeError ? 'var(--error-color)' : 'var(--hover-success-color)'}"
            >
              {{ codeMsg }}
            </small>
          </div>
    ...
    <article class="card">
      ...
      <div class="preview">
        ...
        <div class="badges">
          <span class="badge" :style="{background: 'var(--tx-expense-color)', color: 'var(--white)'}">
            {{ t('transactions.form.expense') }}
          </span>
          <span class="badge" :style="{background: 'var(--tx-goal-color)', color: 'var(--black)'}">
            {{ t('transactions.form.goalSaving') }}
          </span>
          <span class="badge" :style="{background: 'var(--tx-debtPayment-color)', color: 'var(--white)'}">
            {{ t('transactions.form.debtPayment') }}
          </span>
          <span class="badge" :style="{background: 'var(--tx-income-color)', color: 'var(--white)'}">
            {{ t('transactions.form.income') }}
          </span>
          <span class="badge" :style="{background: 'var(--tx-transfer-color)', color: 'var(--black)'}">
            {{ t('common.transfer') }}
          </span>
        </div>
        <div class="buttons">
