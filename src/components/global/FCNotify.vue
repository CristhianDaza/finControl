...
.toast{background:var(--primary-color);color:var(--text-color);border:1px solid var(--secondary-color);padding:.75rem 1rem;border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,.25);overflow:hidden}
